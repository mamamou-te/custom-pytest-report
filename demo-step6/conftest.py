...
def pytest_runtest_makereport(item, call):
    ...
    if report.when == "call":
        ...
        print(extras)
        # pytest_html.report_data.ReportData.append_teardown_log(report, "toto")
        # print(dir(pytest_html.report_data.ReportData.append_teardown_log("toto")))
        print(pytest_html.report_data.ReportData.append_teardown_log)
        print(dir(pytest_html.util))
        extras.append(pytest_html.extras.text("Additional details"))
        extras.append(pytest_html.extras.text("Additional details2"))
        xfail = hasattr(report, "wasxfail")
        # if report.longrepr:
        #     if report.failed:
        #         report.longrepr = str(report.longrepr) + "\n\nTest failed. Add here further logs"
        #     elif report.passed:
        #         report.longrepr = str(report.longrepr) + "\n\nTest Successful. Add here further logs"
        #         print("aalalalalallala")
        #         print(report.caplog)
        #         # return
        #     # elif report.skipped:
        #     #     print(type(report.longrepr))
        #     #     print(report.longrepr)
        #     #     print(report.longreprtext)
        #     #     print(report.caplog)
        #     #     report.longrepr = str(report.longrepr) + "\n\nTest Skip. Add here further logs"
        #     else: 
        #         report.longrepr = str(report.longrepr) + "\n\nTest Successful. Add here further logs"
        #         print("aalalalalallala")
        #         print(report.caplog)
            #     report.longrepr = str(report.longrepr) + "\n\nTest expected failure. Add here further logs"
